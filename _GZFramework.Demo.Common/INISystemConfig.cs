...
namespace _GZFramework.Demo.Common
{
    public class INISystemConfig
    {
        ...
        {
            return Ini.IniReadValue(SessionSystem, "TabClosePageButton");
        }
        /// <summary>
        ...
        {
            Ini.IniWriteValue(SessionSystem, "TabClosePageButton", Position);
        }
        ...
        {
            return Ini.IniReadValue(SessionSystem, "TabHeaderOrientation");
        }
        /// <summary>
        ...
        {
            Ini.IniWriteValue(SessionSystem, "TabHeaderOrientation", Position);
        }
